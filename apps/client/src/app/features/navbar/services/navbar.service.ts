...
import {
  NavLinks,
  OptionLinks,
} from '@client/app/features/navbar/models/types';
...
export class NavbarService {
  ...
  // Define the navigation links and options
    ...
    this._breakpointObserverService
      ...
      .subscribe((breakpoint: Breakpoint) => {
        ...
        this._loggingService.log(
          'info',
          `Breakpoint changed to: ${breakpoint} from NavbarService`
        );
      });
  }
  ...
  /**
   * This method handles navigation to a specific fragment in the application.
   * @param {string} fragment to navigate to
   * @param {Event} event to prevent default behavior
   * @returns {void}
   * @description This method handles navigation to a specific fragment in the application.
   */
   ...
   * @returns {void}
   * @description Adds delay for mobile devices to ensure proper rendering
   */
